...
public class BiomeUtils {
    ...
    public static final Feature<NoFeatureConfig> PATH_GENERATOR = createFeature("path_generator", new WorldPathGenerator(NoFeatureConfig.CODEC));
    public static final ConfiguredFeature<?, ?> CONFIGURED_PATH_GENERATOR = createConfiguredFeature("path_generator", PATH_GENERATOR.configured(NoFeatureConfig.INSTANCE).decorated(Placement.NOPE.configured(NoPlacementConfig.INSTANCE)));
